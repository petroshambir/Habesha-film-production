...
//           <h2 className="text-xl sm:text-2xl md:text-3xl font-serif text-[#dfb557] tracking-wider font-light drop-shadow">
//             Habesha Pictures
//           </h2>
//         </div>
//       </div>
...
//           <span className="text-[10px] uppercase font-bold tracking-[0.4em] text-[#dfb557] block mb-2">
//             Reach Out To Us
//           </span>
//           <h3 className="text-3xl md:text-4xl font-serif text-zinc-100">ርኸቡና</h3>
//           <div className="w-12 h-[1px] bg-[#dfb557]/40 mx-auto mt-3"></div>
...
//             {/* Address */}
//             <div className="bg-zinc-950 border border-[#dfb557]/20 p-6 rounded-2xl shadow-xl flex items-start gap-4">
//               <div className="w-12 h-12 bg-[#dfb557]/10 border border-[#dfb557]/30 rounded-xl flex items-center justify-center text-[#dfb557] text-xl shrink-0">
//                 📍
//               </div>
//               <div>
...
//           <div className="bg-zinc-950 border border-[#dfb557]/30 p-8 md:p-10 rounded-2xl shadow-2xl">
...
//             {submitted ? (
//               <div className="bg-[#dfb557]/10 border border-[#dfb557]/40 p-6 rounded-xl text-center">
//                 <span className="text-3xl block mb-2">✓</span>
//                 <h5 className="text-lg font-serif font-bold text-[#dfb557] mb-1">መልእኽትኹም ብዕወት ተሰዲዱ ኣሎ!</h5>
//                 <p className="text-xs text-zinc-400 font-light">ቀልጢፍና ክንምለሰልኩም ኢና። ብዝሓለፈ ንዝገበርኩምዎ ርክብ ነመስግን።</p>
//                 <button 
//                   onClick={() => setSubmitted(false)}
//                   className="mt-4 bg-[#dfb557] text-black px-4 py-2 text-xs uppercase font-bold tracking-widest rounded-lg hover:bg-[#c99f45] transition-all"
//                 >
//                   ልኣኽ ካልእ መልእኽቲ
//                 </button>
//               </div>
...
//                     required
//                     className="w-full bg-zinc-900 border border-zinc-800 focus:border-[#dfb557] p-3 rounded-xl text-zinc-100 text-sm focus:outline-none transition-colors"
//                   />
//                 </div>
...
//                     required
//                     className="w-full bg-zinc-900 border border-zinc-800 focus:border-[#dfb557] p-3 rounded-xl text-zinc-100 text-sm focus:outline-none transition-colors resize-none"
//                   ></textarea>
//                 </div>
...
//                   type="submit"
//                   disabled={submitting}
//                   className="w-full bg-[#dfb557] text-black py-3.5 rounded-xl text-xs uppercase font-bold tracking-[0.2em] hover:bg-[#c99f45] transition-all shadow-lg disabled:opacity-50"
//                 >
...
//         <div className="w-full h-full rounded-2xl overflow-hidden border border-[#dfb557]/20 shadow-2xl relative">
//           <iframe 
      ...
      <section className="py-20 px-4 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            {/* Email - ብቐጥታ ናብ ኢመይል ዝወስድ ሊንክ ተስተኻኪሉ */}
            <div className="bg-zinc-950 border border-[#dfb557]/20 p-6 rounded-2xl shadow-xl flex items-start gap-4">
              <div className="w-12 h-12 bg-[#dfb557]/10 border border-[#dfb557]/30 rounded-xl flex items-center justify-center text-[#dfb557] text-xl shrink-0">
                ✉️
              </div>
              <div>
                ...
                <a 
                  ...
                  className="block text-zinc-400 text-sm mt-1 font-light hover:text-[#dfb557] transition-colors underline underline-offset-4"
                >
