    ...
    <div className="min-h-screen bg-[#050505] text-zinc-100 font-sans selection:bg-[#dfb557]/30 selection:text-[#dfb557] overflow-x-hidden flex flex-col justify-between">
      ...
      <section className="py-20 px-4 max-w-5xl mx-auto text-center">
        ...
        <p className="text-zinc-400 text-base md:text-lg leading-relaxed font-light max-w-3xl mx-auto mb-12">
          ሕብረተሰብና ብፍሉይ ስነ-ጥበባዊ መነጽር ንምግላጽን፡ ናይ መርዓ፡ ሰነዳውን (Documentary) ድራማውን ቀረጻታት ብዝለዓለ ኳሊቲ ንምቕራብን ዝተጣየሸ ስቱድዮ ኢና። ንነፍስወከፍ ፍጻመ ብናይ ሓቂ ስምዒትን ብሉጽ ቀረጻን ናብ ዘልኣለማዊ ታሪኽ ንቕየሮ።
        </p>
      </section>
      ...
      <section className="py-12 px-4 max-w-7xl mx-auto w-full mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          {/* Gallery Item 1 */}
          <div className="group relative bg-zinc-950 border border-[#dfb557]/20 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-5 text-left bg-gradient-to-t from-zinc-950 to-zinc-900/80">
              <span className="text-[10px] uppercase font-bold tracking-widest text-[#dfb557]">Cinematography</span>
          ...
          <div className="group relative bg-zinc-950 border border-[#dfb557]/20 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-5 text-left bg-gradient-to-t from-zinc-950 to-zinc-900/80">
              <span className="text-[10px] uppercase font-bold tracking-widest text-[#dfb557]">Wedding Stories</span>
          ...
          <div className="group relative bg-zinc-950 border border-[#dfb557]/20 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-5 text-left bg-gradient-to-t from-zinc-950 to-zinc-900/80">
              <span className="text-[10px] uppercase font-bold tracking-widest text-[#dfb557]">Studio Session</span>
          ...
          <div className="group relative bg-zinc-950 border border-[#dfb557]/20 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-5 text-left bg-gradient-to-t from-zinc-950 to-zinc-900/80">
              <span className="text-[10px] uppercase font-bold tracking-widest text-[#dfb557]">Documentary</span>
          ...
          <div className="group relative bg-zinc-950 border border-[#dfb557]/20 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-5 text-left bg-gradient-to-t from-zinc-950 to-zinc-900/80">
              <span className="text-[10px] uppercase font-bold tracking-widest text-[#dfb557]">Art Direction</span>
          ...
          <div className="group relative bg-zinc-950 border border-[#dfb557]/20 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-5 text-left bg-gradient-to-t from-zinc-950 to-zinc-900/80">
              <span className="text-[10px] uppercase font-bold tracking-widest text-[#dfb557]">Post Production</span>
