...
//   // ናይ መወዳእታ 4 ስእስታት ንኣልቡም ግሪድ ዝግለሉ (ንሕና ካብ index 10 ክሳብ 14 ንወስድለይ ሓደራ)
...
//       {/* 🌟 ኣብዚ ላዕሊ View Full Gallery ዘሎ ክፋል፡ እቶም ናይ መወዳእታ 4 ስእስታት ብናይ ኣልቡም ግሪድ ዲዛይን ተወሲኾም ኣለዉ */}
...
//               return (
//                 <div key={i} className="space-y-2 p-3 rounded-xl bg-zinc-950/70 border border-[#dfb557]/30 shadow-xl flex flex-col justify-between">
...
//                     <span className="text-[8px] tracking-[0.2em] uppercase text-[#dfb557] font-bold block">
//                       Moment 0{actualIdx + 1}
//                     </span>
//                     <h4 className="text-xs sm:text-sm font-serif text-zinc-100 line-clamp-1">
