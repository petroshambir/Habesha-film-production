              ...
              {isWedding ? (
                <div className="w-full space-y-20 md:space-y-24">
                  ...
                  {Array.isArray(section.images) && section.images[0] && (
                    <div className="w-full">
                      <div className="text-center max-w-2xl mx-auto mb-6 md:mb-8 px-6">
                        <span className="text-[10px] md:text-[11px] tracking-[0.6em] uppercase text-[#dfb557] font-bold block mb-2">
                          {customHeadings[0] || defaultHeadings[0]}
                        </span>
                      ...
                      <div className="group w-full h-[320px] sm:h-[400px] md:h-[550px] overflow-hidden shadow-2xl bg-zinc-900 border-y border-[#dfb557]/30">
                        <img 
                          src={section.images[0]} 
                          alt={section.title} 
                          className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" 
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-24 space-y-16 md:space-y-20">
                      {section.images.slice(1, 4).map((img, i) => {
                        ...
                        return (
                          <div key={i} className={`flex ${i % 2 !== 0 ? 'flex-row-reverse md:flex-row-reverse' : 'flex-row md:flex-row'} items-center gap-4 sm:gap-8 md:gap-12`}>
                            <div className="flex-1 space-y-2 sm:space-y-3 md:space-y-4 text-left px-1 sm:px-2">
                              <span className="text-[9px] sm:text-[10px] tracking-[0.4em] uppercase text-[#dfb557] font-bold block">
                                Moment 0{actualIdx + 1}
                              </span>
                            ...
                            <div className="flex-1 w-full flex justify-center">
                              <div className="group aspect-[3/4] w-[130px] sm:w-[200px] md:max-w-md overflow-hidden rounded-t-[80px] sm:rounded-t-[120px] md:rounded-t-[140px] rounded-b-none shadow-2xl bg-zinc-900 border-2 border-[#dfb557]/40">
                                <img src={img} alt={section.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="text-center pt-10 px-6">
                    <Link 
                      to={`/gallery/${generateSlug(section.title)}`}
                      className="text-[11px] md:text-[12px] font-bold uppercase tracking-[0.4em] border-2 border-[#dfb557] px-8 md:px-10 py-3 md:py-4 text-[#dfb557] hover:bg-[#dfb557] hover:text-black transition-all duration-300 inline-block rounded-xl shadow-lg"
                    >
                      View Gallery
                    </Link>
                  </div>
                ...
                <div className={`max-w-7xl mx-auto px-6 flex flex-col ${index % 2 !== 0 ? 'md:flex-row-reverse' : 'md:flex-row'} items-center text-center md:text-left gap-12 md:gap-16 py-12`}>
                  <div className="flex-1 flex flex-col items-center md:items-start justify-center space-y-4">
                    ...
                    <p className="text-base md:text-lg leading-relaxed text-zinc-300 font-light max-w-md pt-4">
                      {section.desc || section.description}
                    </p>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col items-center md:items-start w-full">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                      {Array.isArray(section.images) && section.images.slice(0, 2).map((img, i) => (
                        <div key={i} className={`group aspect-[2/3] overflow-hidden bg-zinc-900 border border-[#dfb557]/40 rounded-xl shadow-2xl ${i === 1 ? 'md:mt-16' : ''}`}>
                          <img src={img} alt={section.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="mt-8 w-full text-center md:text-left flex justify-center md:justify-start">
                      <Link 
                        to={`/gallery/${generateSlug(section.title)}`}
                        className="text-[11px] md:text-[12px] font-bold uppercase tracking-[0.4em] border-2 border-[#dfb557] px-8 py-3 text-[#dfb557] hover:bg-[#dfb557] hover:text-black transition-all duration-300 inline-block rounded-xl shadow-lg"
                      >
                        View Gallery
                      </Link>
                    </div>
