...
// // ምስሊ ናብ ኪሎባይት (KB) ንምቕናስ ዝሕግዝ ፈንክሽን
...
//         // መጠን ስእሊ ካብ 1200 ፒክሰል ንላዕሊ እንተልዩ ንንእሽቶ ሚዛን ነጉድሎ
...
//         // Quality ናብ 0.7 (70%) ብምቕናስ ናብ KB ንምቕያር (JPEG)
//         canvas.toBlob((blob) => {
...
//     alert('ስእሊታት ናብ KB ይቕየሩ ኣለዉ፣ በጃኹም ቅሩብ ጽንሑ...');

//     const formData = new FormData();
//     for (let file of files) {
//       // ነፍስወከፍ ስእሊ ናብ KB ንምቕናስ ነቲ compressImageFile ንጥቀመሉ
...
// // ምስሊ ናብ ኣዝዩ ንኡስ ኪሎባይት (KB) ንምቕናስ ዝሕግዝ ፈንክሽን (Quality 0.1 ወይ 0.2 ንምግባር)
// const compressImageFile = (file) => {
//   return new Promise((resolve) => {
//     const reader = new FileReader();
//     reader.readAsDataURL(file);
...
//         // Quality ናብ 0.2 (ወይ ካብኡ ንታሕቲ) ብምቕናስ ሳይዙ ኣዝዩ ንኡስ (KB) ክኸውን ይግበር
//         canvas.toBlob((blob) => {
//           const compressedFile = new File([blob], file.name, {
//             type: 'image/jpeg',
//             lastModified: Date.now(),
...
//     // ንዝተመረጹ ምስልታት ምስቲ ቅድሚ ሕጂ ዘሎ ተደሚሩ ካብ 500 ንላዕሊ እንተልዩ ምዕጋት
...
//     const BATCH_SIZE = 3; // ነፍሲ ወከፍ ግዜ 3 ምስልታት ጥራይ ሰቅል (Timeout ንምክልኻል)
...
//         // ነፍሲ ወከፍ ባች ምስ ተወድአ እቲ UI ቀልጢፉ ክጉዓዝ State ነዘምኖ
//         setData({
//           ...data,
//           images: allNewImages,
...
//     } finally {
//       event.target.value = ''; // ፋይል ኢንፑት ዳግማይ ንምጽዓን ጽሩይ ይግበር
//     }
//   };
