...
//   // ናይ ሳድባር ንጡፍ ክፋል ንምምራጽ (Active Tab State)
//   const [activeTab, setActiveTab] = useState('manager'); // 'manager', 'portal', 'price', or section title

//   // --- States for Price Component Integration ---
...
//   useEffect(() => {
//     // Check main projects/sections data
//     fetch('https://habesha-film-production-server.onrender.com/api/projects')
//       .then(res => res.json())
//       .then(data => {
//         const dataMap = {};
...
//     // Check Price page local authentication
...
//   const handlePriceLogin = async (e) => {
//     e.preventDefault();
//     setLoading(true);
//     setError(false);
...
//               <div onClick={() => setActiveTab('price')} className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl cursor-pointer hover:border-amber-500/50 transition-all group">
//                 <h3 className="text-lg font-bold text-amber-300 group-hover:text-amber-400 mb-1">Price Management</h3>
//                 <p className="text-2xl font-black text-amber-400 mt-2">Packages</p>
//                 <p className="text-xs text-zinc-500 mt-2">ናይ ዋጋ ደረጃታትን ፓኬጃትን ተቆጻጸር</p>
//               </div>
...
//                 <div className="bg-zinc-900 p-8 md:p-12 shadow-2xl border-2 border-amber-500/40 rounded-2xl max-w-md w-full text-center relative">
//                   <span className="text-[9px] md:text-[10px] tracking-[0.4em] uppercase text-amber-400 font-semibold block mb-2">
//                     Secure Access
//                   </span>
//                   <h2 className="text-2xl md:text-3xl font-serif mb-3 text-white">Protected Price Page</h2>
//                   <div className="w-12 h-[1px] bg-amber-500/40 mx-auto mb-4"></div>
//                   <p className="text-xs md:text-sm text-zinc-400 mb-6 font-light">
//                     እዚ ገጽ ብሚጢራዊ ፓስኮድ ዝተዓጸወ እዩ። በጃኹም ፓስኮድ ኣእትዉ።
//                   </p>
                  
//                   <form onSubmit={handlePriceLogin} className="space-y-4">
//                     <input 
//                       type="password"
//                       placeholder="Enter Passcode"
//                       value={passcode}
//                       onChange={(e) => setPasscode(e.target.value)}
//                       className="w-full px-4 py-3 bg-zinc-950 border border-amber-500/50 rounded-xl focus:outline-none focus:border-amber-400 text-center tracking-widest text-lg text-white placeholder-zinc-500 shadow-inner"
//                     />
//                     <button 
//                       type="submit"
//                       disabled={loading}
//                       className="w-full bg-amber-500 text-black py-3 uppercase text-xs font-bold tracking-[0.3em] hover:bg-amber-400 transition-all duration-300 disabled:opacity-50 rounded-xl shadow-lg"
//                     >
...
//               </div>
//             ) : (
//               <div className="max-w-7xl mx-auto text-center px-4 py-6">
//                 <span className="text-[10px] md:text-[11px] tracking-[0.5em] uppercase text-amber-400 font-medium block mb-2">
//                   Investment & Tiers
//                 </span>
//                 <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif mb-4 text-white">Our Professional Packages</h1>
//                 <div className="w-12 h-[1px] bg-amber-500/40 mx-auto mb-4"></div>
...
//                   {/* 1. Premium Package */}
//                   <div className="bg-zinc-900 border-2 border-amber-500/50 p-6 sm:p-8 rounded-2xl shadow-2xl flex flex-col justify-between transition-transform hover:-translate-y-1">
//                     <div>
//                       <span className="text-[10px] uppercase font-bold tracking-[0.3em] text-amber-400">Ultimate VIP</span>
//                       <h3 className="text-2xl font-serif mt-1 mb-2 text-white">Premium</h3>
...
//                         <li className="flex items-center gap-2">✓ <b className="font-semibold text-amber-400">Cinematic Color Grading</b> & VFX</li>
//                         <li className="flex items-center gap-2 text-amber-400 font-medium">🎁 <b className="font-semibold">ቦናስ:</b> ምሉእ ድሮን ቀረጻ + ሓደ ነጻ ዌብሳይት ባነር</li>
//                       </ul>
//                     </div>
//                     <button className="w-full bg-zinc-950 border border-amber-500/50 text-zinc-100 py-3 text-[11px] uppercase font-bold tracking-[0.3em] hover:bg-amber-500 hover:text-black transition-all duration-300 rounded-xl shadow-md">
//                       Select Premium
//                     </button>
//                   </div>

//                   {/* 2. Gold Package */}
//                   <div className="bg-zinc-900 border-2 border-amber-500 p-6 sm:p-8 rounded-2xl shadow-2xl relative flex flex-col justify-between transition-transform hover:-translate-y-1">
//                     <span className="absolute -top-3 right-6 bg-amber-500 text-black text-[9px] uppercase font-bold tracking-[0.3em] px-3 py-1 rounded-full shadow-md">
//                       Top Tier
//                     </span>
//                     <div>
//                       <span className="text-[10px] uppercase font-bold tracking-[0.3em] text-amber-400">Exclusive</span>
//                       <h3 className="text-2xl font-serif mt-1 mb-2 text-white">Gold</h3>
//                       <p className="text-3xl font-serif font-bold text-amber-400 mb-6">300,000</p>
                      
//                       <div className="text-xs sm:text-sm text-zinc-300 mb-4 font-light space-y-1.5 border-b border-zinc-800 pb-3">
//                         <p className="text-amber-400 font-semibold uppercase tracking-wider text-[10px]">ናይ ቀረጻ ኣገልግሎታት:</p>
...
//                       </ul>
//                     </div>
//                     <button className="w-full bg-amber-500 text-black py-3 text-[11px] uppercase font-bold tracking-[0.3em] hover:bg-amber-400 transition-all duration-300 rounded-xl shadow-lg">
//                       Select Gold
//                     </button>
//                   </div>
...
//                   <div className="bg-zinc-900 border-2 border-amber-500/50 p-6 sm:p-8 rounded-2xl shadow-2xl flex flex-col justify-between transition-transform hover:-translate-y-1">
//                     <div>
//                       <span className="text-[10px] uppercase font-bold tracking-[0.3em] text-amber-400">Advanced</span>
//                       <h3 className="text-2xl font-serif mt-1 mb-2 text-white">Silver</h3>
//                       <p className="text-3xl font-serif font-bold text-amber-400 mb-6">240,000</p>
...
//                   {/* 4. Standard Package */}
//                   <div className="bg-zinc-900/70 border-2 border-amber-500/30 p-6 sm:p-8 rounded-2xl shadow-xl flex flex-col justify-between transition-transform hover:-translate-y-1">
//                     <div>
//                       <span className="text-[10px] uppercase font-bold tracking-[0.3em] text-zinc-400">Standard</span>
//                       <h3 className="text-2xl font-serif mt-1 mb-2 text-white">Standard</h3>
//                       <p className="text-3xl font-serif font-bold text-amber-400 mb-6">190,000</p>
...
//   { title: 'Bridal Shoots', storageKey: 'portfolio_bridal' },
//   { title: 'Baby Shower & Baptism', storageKey: 'portfolio_babyshower' },
//   { title: 'Pricing', storageKey: 'portfolio_pricing' }
// ];
...
//                   <h3 className="text-lg font-bold text-amber-300 group-hover:text-amber-400 mb-1">{sec.title}</h3>
//                   <p className="text-2xl font-black text-white mt-2">
//                     {sec.title === 'Pricing' ? (sectionsData[sec.title]?.desc ? '1 Active' : '0') : `${sectionsData[sec.title]?.images?.length || 0} Photos`}
//                   </p>
//                   <p className="text-xs text-zinc-500 mt-2">ናיዚ ክፍሊ መግለጫን ዝርዝርን ኣስተኻኽል</p>
//                 </div>
//               ))}
//             </div>
//           </div>
...
//             {isPricing ? 'Pricing Packages / Details (ዋጋታት መግለጫ):' : 'Section Main Description (መግለጫ):'}
//           </label>
//           <textarea 
//             rows={isPricing ? "8" : "3"}
//             value={data.desc || ''}
//             onChange={(e) => setData({ ...data, desc: e.target.value })}
//             className="bg-zinc-800 border border-zinc-600 p-3 rounded-lg w-full text-white text-sm focus:outline-none focus:border-amber-400 transition-colors"
//             placeholder={isPricing ? "ንኣብነት: Package 1: $500 - Wedding shoot..." : "እዚ ስራሕ እዚ ዝገልጽ ጽሑፍ ኣብዚ ጽሓፍ..."}
//           />
//         </div>
      ...
      .then(data => {
        ...
        data.forEach(item => {
          ...
          if (item.title === 'Pricing') {
            try {
              parsedPricingTiers = typeof item.desc === 'string' ? JSON.parse(item.desc) : (item.desc || parsedPricingTiers);
            } catch (e) {
              console.log("Pricing JSON parse error", e);
            }
          }
  ...
  const handleSave = async (title, data) => {
    try {
      ...
      if (title === 'Pricing') {
        payload = {
          title: title,
          description: JSON.stringify(data.pricingTiers),
          desc: JSON.stringify(data.pricingTiers),
          images: [],
          descriptions: [],
          headings: []
        };
        ...
        <div>
          ...
          <nav className="flex md:flex-col gap-2 overflow-x-auto md:overflow-x-visible pb-2 md:pb-0 scrollbar-none">
            <button
              onClick={() => setActiveTab('manager')}
              className={`whitespace-nowrap px-4 py-3 rounded-xl font-medium text-sm transition-all flex items-center justify-between ${
                activeTab === 'manager' ? 'bg-amber-500 text-black font-bold shadow-lg' : 'text-zinc-300 hover:bg-zinc-800 hover:text-white'
              }`}
            >
              <span>📊 Dashboard Overview</span>
            </button>
            ...
            <button
              onClick={() => setActiveTab('portal')}
              className={`whitespace-nowrap px-4 py-3 rounded-xl font-medium text-sm transition-all flex items-center justify-between ${
                activeTab === 'portal' ? 'bg-amber-500 text-black font-bold shadow-lg' : 'text-zinc-300 hover:bg-zinc-800 hover:text-white'
              }`}
            >
              <span>👥 Client Portals</span>
              <span className={`text-xs px-2 py-0.5 rounded-full ml-2 ${activeTab === 'portal' ? 'bg-black text-amber-400' : 'bg-zinc-800 text-zinc-400'}`}>
            ...
            {sectionsConfig.map((sec) => (
              <button
                ...
                onClick={() => setActiveTab(sec.title)}
                className={`whitespace-nowrap px-4 py-3 rounded-xl font-medium text-sm transition-all flex items-center justify-between ${
                  activeTab === sec.title ? 'bg-amber-500 text-black font-bold shadow-lg' : 'text-zinc-300 hover:bg-zinc-800 hover:text-white'
                }`}
              >
                <span>✨ {sec.title}</span>
              </button>
      ...
      <main className="flex-1 p-4 md:p-10 overflow-y-auto max-w-full">
        {activeTab === 'manager' && (
          <div className="space-y-6">
            <div className="bg-zinc-900 border border-zinc-800 p-6 md:p-8 rounded-2xl">
              <h2 className="text-2xl md:text-3xl font-bold text-amber-400 mb-2">Welcome to Admin Control Panel</h2>
              <p className="text-zinc-400 text-sm">መረብካ (Website) ንምምሕዳር ካብዚ ሳድባር ዝደለኻዮ ክፍሊ ብምጥዋቕ ብቐሊሉ ክትእርምን ስእሊታት ክተሰቅልን ትኽእል።</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <div onClick={() => setActiveTab('portal')} className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl cursor-pointer hover:border-amber-500/50 transition-all">
                <h3 className="text-lg font-bold text-amber-300 mb-1">Active Client Portals</h3>
                <p className="text-2xl font-black text-white mt-2">{portalsList.length}</p>
              </div>
              {sectionsConfig.map(sec => (
                <div key={sec.title} onClick={() => setActiveTab(sec.title)} className="bg-zinc-900 border border-zinc-800 p-6 rounded-2xl cursor-pointer hover:border-amber-500/50 transition-all">
                  <h3 className="text-lg font-bold text-amber-300 mb-1">{sec.title}</h3>
                  <p className="text-2xl font-black text-white mt-2">
                    {sec.title === 'Pricing' ? '4 Tiers' : `${sectionsData[sec.title]?.images?.length || 0} Photos`}
                  </p>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-8">
            <div className="p-4 md:p-6 border border-amber-500/50 rounded-2xl bg-zinc-900 shadow-2xl">
              ...
              <form onSubmit={handleCreatePortal} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-zinc-400 mb-1 text-sm">Client Name:</label>
                    <input type="text" value={clientName} onChange={(e) => setClientName(e.target.value)} placeholder="Dawit & Meron" className="bg-zinc-800 border border-zinc-700 p-3 rounded-lg w-full text-white text-sm" required />
                  </div>
                  <div>
                    <label className="block text-zinc-400 mb-1 text-sm">Portal Number:</label>
                    <input type="text" value={portalNumber} onChange={(e) => setPortalNumber(e.target.value)} placeholder="01" className="bg-zinc-800 border border-zinc-700 p-3 rounded-lg w-full text-white text-sm" required />
                  </div>
                </div>
                <div>
                  <label className="block text-zinc-400 mb-1 text-sm">Upload Client Photos:</label>
                  <input type="file" multiple onChange={handleClientImageUpload} className="w-full bg-zinc-800 p-2 rounded-lg text-xs" />
                </div>
                <button type="submit" disabled={creatingPortal} className="bg-amber-500 hover:bg-amber-600 text-black font-bold px-6 py-3 rounded-lg w-full text-sm">
        ...
        {sectionsConfig.map((sec) => {
          if (activeTab !== sec.title) return null;
          const currentData = sectionsData[sec.title] || { pricingTiers: { Premium:{price:'',details:''}, Gold:{price:'',details:''}, Silver:{price:'',details:''}, Standard:{price:'',details:''} }, images: [] };
...
function SectionRenderer({ title, data, setData, onSave }) {
  ...
  const handleTierChange = (tierName, field, value) => {
    const updatedTiers = {
      ...data.pricingTiers,
      [tierName]: {
        ...data.pricingTiers[tierName],
        [field]: value
      }
    };
    setData({ ...data, pricingTiers: updatedTiers });
  };

  return (
    <div className="p-4 md:p-8 border border-zinc-700 rounded-2xl bg-zinc-900 shadow-2xl">
      <div className="flex justify-between items-center mb-6 border-b border-zinc-700 pb-4">
        <h2 className="text-xl md:text-3xl font-bold text-amber-300">{title} Control Panel</h2>
        <button onClick={onSave} className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg font-bold text-sm">
          Save {title}
        </button>
      </div>
      ...
      {isPricing ? (
        <div className="space-y-6">
          <p className="text-xs text-zinc-400 mb-4">ነቶም ኣብ ቅድሚ ገጽ (Price Page) ዝረኣዩ 4 ፓኬታት (Premium, Gold, Silver, Standard) ዋጋታቶምን ዝርዝራቶምን ካብዚ ኣስተኻኽል። ዝርዝራት ከተእቱ ከለኻ ብኮማ (,) ፈለዮም።</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {Object.entries(data.pricingTiers || {}).map(([tierName, tierInfo]) => (
              <div key={tierName} className="bg-zinc-800/60 border border-zinc-700 p-5 rounded-xl space-y-3">
                <h3 className="text-amber-400 font-bold uppercase tracking-wider text-sm">{tierName} Package</h3>
                <div>
                  <label className="block text-xs text-zinc-400 mb-1">Price (ንኣብነት: $500 ወይ Contact Us):</label>
                  <input 
                    type="text"
                    value={tierInfo.price || ''}
                    onChange={(e) => handleTierChange(tierName, 'price', e.target.value)}
                    className="bg-zinc-900 border border-zinc-700 p-2.5 rounded w-full text-sm text-white"
                    placeholder="$500"
                  />
                </div>
                <div>
                  <label className="block text-xs text-zinc-400 mb-1">Details (ብኮማ ',' ፈልዩ ጽሓፍ):</label>
                  <textarea 
                    rows="3"
                    value={tierInfo.details || ''}
                    onChange={(e) => handleTierChange(tierName, 'details', e.target.value)}
                    className="bg-zinc-900 border border-zinc-700 p-2.5 rounded w-full text-sm text-white"
                    placeholder="Full HD Video, 2 Photographers, Edited Album"
                  />
                </div>
              </div>
            ))}
        ...
        <div>
          {/* ንኻልኦት ክፍስታት ዝኸውን መግለጫን ስእሊታትን ምምሕዳር */}
          <p className="text-zinc-400">እዚ ክፍሊ ንስእሊታትን መግለጫታትን ዝቆጻጸር እዩ።</p>
        </div>
      )}
    </div>
  );
