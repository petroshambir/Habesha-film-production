...
//                   </p>
//                   <p className="text-xs text-zinc-500 mt-2">ናيዚ ክፍሊ መግለጫን ስእሊታትን ኣስተኻኽል</p>
//                 </div>
//               ))}
//             </div>
//           </div>
...
//               <div className="relative w-full sm:w-28 h-28 flex-shrink-0 border border-zinc-700 rounded-lg overflow-hidden">
//                 <img src={imgSrc} className="w-full h-full object-cover" alt="upload" />
//                 <button onClick={() => deleteImage(index)} className="absolute top-1 right-1 bg-red-600 hover:bg-red-700 text-white p-1 rounded-md text-xs font-bold">
//                   ✕
//                 </button>
//               </div>
...
//             onChange={(e) => setData({ ...data, desc: e.target.value })}
//             className="bg-zinc-800 border border-zinc-600 p-3 rounded-lg w-full text-white mb-6 text-sm"
//             placeholder="ናይዚ ክፍሊ ዋና መግለጫ ጽሓፍ..."
//           />
//         </div>

//         <div className="flex flex-col w-full">
//           <label className="block text-zinc-400 mb-2 text-sm">Upload Photos to {title} (Max 500):</label>
//           <input 
//             type="file" 
//             multiple
//             onChange={handleImageUpload}
//             className="text-zinc-400 text-xs file:mr-2 file:py-2 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-amber-500 file:text-black hover:file:bg-amber-400 w-full bg-zinc-800 p-2 rounded-lg mb-4" 
//           />
//           <p className="text-xs text-zinc-500 mb-4">ጠቕላላ ስእሊታት: {(data.images || []).length} / 500</p>
//         </div>
//       </div>

//       <div className="mt-6 border-t border-zinc-700 pt-6">
//         <h3 className="text-lg font-bold text-zinc-200 mb-4">Manage Section Images & Captions</h3>
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
//           {(data.images || []).map((imgUrl, index) => (
//             <div key={index} className="bg-zinc-800 p-3 rounded-xl border border-zinc-700 flex flex-col gap-3">
...
//                   className="absolute top-2 right-2 bg-red-600 hover:bg-red-700 text-white p-1.5 rounded-lg text-xs font-bold"
//                 >
//                   ✕
//                 </button>
//               </div>
...
//                   onChange={(e) => handleHeadingChange(index, e.target.value)}
//                   placeholder="Heading..."
//                   className="bg-zinc-900 border border-zinc-700 p-2 rounded text-xs text-white w-full"
//                 />
//                 <textarea 
//                   rows="2"
...
//                   className="bg-zinc-900 border border-zinc-700 p-2 rounded text-xs text-white w-full resize-none"
//                 />
//               </div>
//             </div>
//           ))}
...
//                   onChange={(e) => handleHeadingChange(index, e.target.value)}
//                   placeholder="Image Heading..."
//                   className="bg-zinc-900 border border-zinc-700 p-2 rounded text-xs text-white"
//                 />
//                 <textarea 
//                   rows="2"
//                   value={(data.descriptions || [])[index] || ''}
...
//               <button 
//                 onClick={() => deleteImage(index)}
//                 className="bg-red-600 hover:bg-red-700 text-white p-1.5 rounded text-xs font-bold transition-colors"
//               >
//                 Delete Image
//               </button>
//             </div>
          ...
          {(data.images || []).map((imgUrl, index) => (
            <div key={index} className="bg-zinc-800 p-3 rounded-xl border border-zinc-700 flex flex-col gap-3">
              ...
              <input 
                ...
                onChange={(e) => handleHeadingChange(index, e.target.value)}
                placeholder="Heading"
                className="bg-zinc-950 border border-zinc-700 p-2 rounded text-xs text-white"
              />
              <textarea 
                rows="2"
                value={(data.descriptions || [])[index] || ''}
              ...
              <button 
                onClick={() => deleteImage(index)}
                className="bg-red-900/50 hover:bg-red-800 text-red-200 text-[10px] uppercase font-bold py-1.5 rounded transition-colors"
              >
                Delete
              </button>
            </div>
