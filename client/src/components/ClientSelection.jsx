      ...
      <Lightbox
        ...
        render={{
          slide: ({ slide }) => {
            ...
            return (
              <div
                className="relative w-full h-full flex flex-col items-center justify-center p-2 select-none"
                onContextMenu={(e) => e.preventDefault()}
              >
                <div className="relative flex items-center justify-center w-full flex-grow overflow-hidden">
                  <ProtectedImage
                    src={slide.src}
                    alt="Lightbox Protected"
                    className="max-h-[75vh] w-auto h-auto object-contain rounded-lg shadow-2xl mx-auto transition-transform duration-200"
                    showLogoOnly={false}
                    style={{
                ...
                <div className="absolute top-5 right-5 z-[60] flex items-center gap-2">
                  <button
                    ...
                    className="w-11 h-11 rounded-full bg-black/70 border border-white/20 text-white text-2xl flex items-center justify-center hover:bg-black hover:border-[#dfb557] hover:text-[#dfb557] transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-xl"
                    aria-label="Zoom out"
                  >
                    −
                  </button>
