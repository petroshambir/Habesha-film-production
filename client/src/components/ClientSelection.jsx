      ...
      <div className="flex-grow flex flex-col items-center justify-center px-4 py-24">
          ...
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            <div className="bg-white p-8 rounded-2xl shadow-2xl max-w-md w-full border border-zinc-200 text-center relative">
              ...
              <p className="text-sm text-zinc-600 mb-6">
                ናብ <b>{selectedPortalForPasscode.clientName}</b> ፖርታል ንምእታው በጃኹም እቲ ካብ ስቱድዮ ዝተዋህበኩም 4-ቁጽሪ ኮድ ኣእትዉ።
              </p>
              ...
              <form onSubmit={handleVerifyPasscode} className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button 
                    type="submit"
                    disabled={verifying}
                    className="bg-amber-600 text-white px-4 py-2 rounded-lg text-xs uppercase font-bold tracking-widest hover:bg-amber-700 w-1/2 disabled:opacity-50"
                  >
        ...
        {!project ? (
          <div className="bg-white p-8 md:p-12 shadow-2xl border border-zinc-200 max-w-xl w-full text-center">
            ...
            <p className="text-sm text-zinc-600 mb-6">በጃኹም ንምርጫ ስእሊታት ናይቲ ስቱድዮ ሽምኩም ጠውቑ።</p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 border-b pb-6 sticky top-20 bg-[#fcfbf9] z-10 py-4">
              ...
              <div className="mt-4 md:mt-0 flex items-center gap-4">
                ...
                <button 
                  ...
                  className="bg-amber-600 text-white px-6 py-3 text-xs uppercase font-bold tracking-widest hover:bg-amber-700 transition-colors disabled:opacity-50 shadow-md flex items-center gap-2"
                >
                ...
                project.images.map((imgUrl, index) => {
                  ...
                  return (
                    <div 
                      ...
                      className={`relative group cursor-pointer overflow-hidden border-2 rounded-xl transition-all aspect-square bg-zinc-100 ${
                        isSelected ? 'border-amber-600 shadow-xl scale-[0.98]' : 'border-zinc-200 hover:border-zinc-400'
                      }`}
                    >
                      <img 
                        src={imgUrl} 
                        ...
                        loading="lazy"
                        onError={(e) => {
                          e.target.src = "https://via.placeholder.com/150?text=Image+Loading";
                        }}
                      />
                      
                      <div className="absolute top-2 right-2 z-10 bg-black/40 rounded-md p-1 backdrop-blur-sm">
                        <input 
                          type="checkbox" 
                          checked={isSelected}
                          onChange={() => {}}
                      ...
                      {isSelected && (
                        <div className="absolute inset-0 bg-amber-600/30 pointer-events-none flex items-center justify-center backdrop-blur-[1px]">
                          <span className="bg-amber-600 text-white text-[10px] uppercase font-bold px-2.5 py-1 tracking-widest shadow rounded">
                            Selected
                          </span>
                        </div>
                      )}
...
//                       key={index} 
//                       onClick={() => handleCheckboxChange(imgUrl)}
//                       className={`relative group cursor-pointer overflow-hidden border-2 rounded-xl transition-all aspect-square bg-zinc-900 ${
...
//                   // Clean URL or original URL logic for watermark removal if required by backend, 
//                   // but keeping your image URLs intact as requested.
