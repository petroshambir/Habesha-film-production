...
//         'https://habesha-film-production-server.onrender.com/api/client/portals'
//       );
...
//     try {
//       const response = await fetch(
//         'https://habesha-film-production-server.onrender.com/api/client/verify-client-passcode',
//         {
//           method: 'POST',
//           headers: { 'Content-Type': 'application/json' },
//           body: JSON.stringify({
...
//       item => item.original === imgObj.original
//     );
...
//       const response = await fetch(
//         `https://habesha-film-production-server.onrender.com/api/client/submit-selection/${targetId}`,
//         {
//           method: 'POST',
//           headers: {
...
//             <h2 className="text-2xl md:text-3xl font-serif mb-2 text-zinc-100">
...
//                       <span className="text-[10px] uppercase font-bold tracking-widest text-[#dfb557] group-hover:text-black/70">
//                         Portal #{portal.portalNumber}
//                       </span>

//                       <h3 className="text-base font-serif font-bold text-zinc-100 group-hover:text-black mt-1">
//                         {portal.clientName}
//                       </h3>
...
//             <div className="w-16 h-16 bg-[#dfb557]/20 text-[#dfb557] border border-[#dfb557]/40 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl shadow-inner">
//               ✓
//             </div>

//             <h2 className="text-2xl font-serif mb-2 text-zinc-100">
//               ምርጫኹም ብዕወት ተሰዲዱ ኣሎ!
//             </h2>
...
//                 <span className="text-[10px] uppercase font-bold tracking-widest text-[#dfb557] block">
//                   Welcome, {project.clientName}
//                 </span>

//                 <h1 className="text-2xl md:text-3xl font-serif text-zinc-100">
...
//                 <div className="bg-zinc-900 border border-[#dfb557]/30 text-zinc-200 px-6 py-3 rounded-xl shadow-inner text-sm font-medium">
//                   Selected Images:{' '}
//                   <span className="text-[#dfb557] font-bold text-lg">
//                     {selectedImages.length}
//                   </span>
//                 </div>
...
//                       className={`relative group overflow-hidden border-2 rounded-xl transition-all aspect-square bg-zinc-900 cursor-pointer ${
//                         isSelected
//                           ? 'border-[#dfb557] shadow-2xl scale-[0.98]'
...
//         render={{
//           slideFooter: ({ slide }) => {
//             const currentImgObj = project?.images.find(
//               item => item.original === slide.src
//             );
...
//                   onClick={() =>
//                     currentImgObj &&
//                     handleCheckboxChange(currentImgObj)
//                   }
//                   className={`pointer-events-auto px-6 py-2.5 rounded-xl text-xs uppercase font-bold tracking-widest transition-all shadow-lg ${
//                     isCurrentSelected
//                       ? 'bg-red-500/80 text-white hover:bg-red-600'
//                       : 'bg-[#dfb557] text-black hover:bg-[#c99f45]'
//                   }`}
...
function ClientSelection() {
  ...
  const lightboxSlides =
    project?.images?.map((imgObj) => ({
      ...
      // ONLY FOR YARL ZOOM
      // These dimensions allow the custom ProtectedImage
      // to work correctly with the Zoom plugin.
      width: 2000,
      height: 1333
    })) || [];
